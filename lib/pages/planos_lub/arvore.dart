...
class _AreaState extends State<Arvore> {
  ...
  IconData _fabIcon = Icons.arrow_downward;
  ...
  void initState() {
    ...
    _scrollController.addListener(_updateFabIcon);
    _carregarDados();
    _carregarAreas();
  }
  ...
  void _updateFabIcon() {
    if (_scrollController.hasClients) {
      ...
      setState(() {
        _fabIcon = currentPosition == maxScrollExtent
            ? Icons.arrow_upward
  ...
  @override
  void dispose() {
    _scrollController.removeListener(_updateFabIcon);
                    ...
                    return ListTile(
                      title: Column(
                        children: [
                          Container(
                            ...
                            child: Row(
                              children: [
                                ...
                                const SizedBox(
                                    width:
                                        10), // Espaço entre o texto e o botão
                                Expanded(
                                  flex:
                                                                  ...
                                                                  actions: <Widget>[
                                                                    ...
                                                                    TextButton(
                                                                      onPressed:
                                                                        ...
                                                                        // Confirma a exclusão
                                                                        _excluirArea(
                                                                            areas[index].id); // Chama o método de exclusão
                                                                        Navigator.of(context)
                                                                            .pop(); // Fecha o diálogo de confirmação
                                                                        Navigator.of(context)
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: <Widget>[
                                                                              ...
                                                                              ElevatedButton(
                                                                                ...
                                                                                child: const Text('Editar Sub Area', style: TextStyle(color: Colors.black)),
                                                                              ),
                                                                              ElevatedButton(
                                                                                onPressed: () {
                                                                                  showDialog(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    onPressed:
                                                                      ...
                                                                      setState(
                                                                          () {
                                                                        linha.isVisible =
                                                                            !linha.isVisible; // Alterna o estado de visibilidade
                                                                      });
                                                                    },
                                                                    icon: Icon(linha
                                                                            .isVisible
                          ...
                          //criar um botão flutuante para subir para o top da tela
                        ],
                      ),
                    );
                  },
                ),
                //deixar ele por cima de tudo
              ],
            ),
          ),
          Positioned(
